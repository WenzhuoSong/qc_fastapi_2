...
def _build_user_message(
    ...
    return (
        ...
        "If trade_style is hold_unless_strong, risk_reduce_fast, or cash_only, "
        "your bullish case must explicitly identify what evidence would overcome that caution. "
