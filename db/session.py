...
async def init_db():
    ...
    migrations = [
        ...
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS correlation_id VARCHAR(96)",
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS source_analysis_id BIGINT",
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMP",
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS policy_version VARCHAR(50)",
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS target_fingerprint VARCHAR(64)",
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS lifecycle_state VARCHAR(40) DEFAULT 'created'",
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS latest_qc_ack_at TIMESTAMP",
        "ALTER TABLE execution_log ADD COLUMN IF NOT EXISTS metadata JSONB",
        ...
        "CREATE INDEX IF NOT EXISTS idx_execution_log_correlation_id ON execution_log (correlation_id)",
        "CREATE INDEX IF NOT EXISTS idx_execution_log_target_fingerprint ON execution_log (target_fingerprint)",
        "CREATE INDEX IF NOT EXISTS idx_execution_log_lifecycle_state ON execution_log (lifecycle_state)",
        ...
        """,
        "ALTER TABLE account_state_snapshots ADD COLUMN IF NOT EXISTS last_command_id VARCHAR(64)",
        "ALTER TABLE account_state_snapshots ADD COLUMN IF NOT EXISTS active_command_id VARCHAR(64)",
        "ALTER TABLE account_state_snapshots ADD COLUMN IF NOT EXISTS active_execution_status VARCHAR(32)",
        "ALTER TABLE account_state_snapshots ADD COLUMN IF NOT EXISTS processed_command_count INTEGER DEFAULT 0",
        ...
        """,
        "CREATE INDEX IF NOT EXISTS idx_deferred_execution_ledger_status ON deferred_execution_ledger (status)",
        "CREATE INDEX IF NOT EXISTS idx_deferred_execution_ledger_ticker ON deferred_execution_ledger (ticker)",
        "CREATE INDEX IF NOT EXISTS idx_deferred_execution_ledger_command_id ON deferred_execution_ledger (command_id)",
        "CREATE INDEX IF NOT EXISTS idx_deferred_execution_ledger_analysis_id ON deferred_execution_ledger (analysis_id)",
        """
