...
class HoldingsFactor(Base):
    ...
    universe_role  = Column(String(20))
    ...
    daily_return_pct = Column(Numeric(8, 6))
...
class AccountStateSnapshot(Base):
    ...
    last_command_id = Column(String(64))
    active_command_id = Column(String(64))
    active_execution_status = Column(String(32))
    processed_command_count = Column(Integer, default=0)
