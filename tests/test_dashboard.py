...
class DashboardTests(unittest.TestCase):
    ...
    def test_dashboard_surfaces_weekend_trading_review_operator_pack(self):
        ...
        self.assertNotIn('"weekend_review_operator": weekend_review_operator', source)
        self.assertNotIn("def _weekend_review_operator_dashboard", source)
        self.assertIn("def _render_weekend_review_operator", source)
        self.assertIn("def _weekend_review_js", source)
        self.assertIn("Weekend Trading Review", source)
        self.assertIn('href="#weekend-review"', source)
        self.assertIn('"weekend-review", "Weekend Trading Review", _render_weekend_review_operator(), True', source)
        self.assertIn('id="weekend-review-text"', source)
        self.assertIn("Loaded asynchronously so weekend review cannot block dashboard startup.", source)
        self.assertIn('fetch("/api/weekend-review/latest/text"', source)
        ...
        self.assertIn('"reason": f"weekend_review_unavailable:{type(exc).__name__}"', source)
        self.assertIn('"reason": "no_weekend_review_found"', source)
        self.assertIn('return {"available": True, **pack}', source)
    ...
    def test_dashboard_surfaces_alpha_basket_hedge_validation_overview(self):
        ...
        self.assertIn("def _validation_overview_dashboard", source)
        self.assertIn("def _render_validation_overview", source)
        self.assertIn('"validation_overview": validation_overview', source)
        self.assertIn("Validation Overview", source)
        self.assertIn("Alpha Evidence Panel", source)
        self.assertIn("Active Basket Panel", source)
        self.assertIn("Hedge Calibration Panel", source)
        self.assertIn("Stress Diagnostics Panel", source)
        self.assertIn("Recent Hedge Outcomes", source)
        self.assertIn("Diagnostics-First Contract", source)
        self.assertIn("alpha_basket_hedge_validation_overview_v1", source)
        self.assertIn("def _hedge_intent_outcome_dashboard", source)
        self.assertIn("summarize_hedge_threshold_assessments", source)
        self.assertIn('"hedge_calibration": hedge_calibration', source)
        self.assertIn("no_hedge_followed_by_drawdown_count", source)
        self.assertIn("hedge_buy_followed_by_rebound_loss_count", source)
        self.assertIn("active_basket_calibration", source)
        self.assertIn("suggested_range", source)
        self.assertIn("max_current_historical_scenario_loss", source)
        self.assertIn("max_current_beta_shock_loss", source)
    ...
    def test_dashboard_surfaces_portfolio_construction_evaluation(self):
        ...
        self.assertIn("hedge_intent_outcome", source)
        self.assertIn("Hedge Intent Outcome Log", source)
        self.assertIn("def _compact_hedge_intent_outcome", source)
    ...
    def test_dashboard_surfaces_etf_strategy_evidence(self):
        ...
        self.assertIn("Strategy Breadth Calibration", source)
        self.assertIn("Duplicate Alpha Pairs", source)
        self.assertIn("Diversifying Strategy Pairs", source)
        ...
        self.assertIn("build_strategy_breadth_calibration_report", source)
        self.assertIn('"strategy_breadth_calibration": strategy_breadth', source)
        self.assertIn('"breadth_duplicate_pairs": strategy_breadth.get("high_correlation_pairs") or []', source)
        self.assertIn('"estimated_independent_clusters"', source)
    ...
    def test_dashboard_surfaces_live_signal_conviction(self):
        ...
        self.assertIn("Statistical Conviction Status Counts", source)
        self.assertIn("Legacy Operational Conviction Status Counts", source)
        self.assertIn('"conviction_number_policy": "no_naked_conviction"', source)
        self.assertIn('"required_context": "conviction_display + source_bucket + n + statistical_status"', source)
        self.assertIn('"statistical_status_count_rows": _dict_count_rows', source)
        self.assertIn('"legacy_operational_status_count_rows": _dict_count_rows', source)
    ...
    def test_dashboard_surfaces_performance_attribution(self):
        ...
        self.assertIn("load_monthly_alpha_attribution_report", source)
        self.assertIn('"performance_attribution": performance_attribution', source)
        self.assertIn("Performance Attribution", source)
        self.assertIn("Monthly Alpha Report", source)
        self.assertIn('"monthly_alpha_report": monthly_report', source)
        self.assertIn('"honest_interpretation"', source)
        self.assertIn('"meets_harvey_t3_threshold"', source)
    ...
    def test_dashboard_surfaces_portfolio_risk_diagnostic(self):
        ...
        self.assertIn("Target Historical Scenario Stress", source)
        self.assertIn("Current Historical Scenario Stress", source)
        self.assertIn("Target Beta Shock", source)
        self.assertIn("Current Beta Shock", source)
        self.assertIn("def _flatten_beta_shock_rows", source)
