...
FACTOR_TAGS: dict[str, tuple[str, ...]] = {
    ...
    "VWO": ("emerging_markets",),
    "GLD": ("gold", "defensive"),
    "ITA": ("defense", "industrials"),
    "XAR": ("defense", "industrials"),
    ...
    "URA": ("nuclear_energy",),
    "GRID": ("clean_energy", "infrastructure"),
    "TQQQ": ("leveraged", "broad_market", "hedges"),
    "SQQQ": ("inverse_equity", "broad_market", "hedges"),
    "SOXL": ("leveraged", "semiconductors", "hedges"),
    "SOXS": ("inverse_equity", "semiconductors", "hedges"),
...
GROUP_DEFINITIONS: dict[str, GroupDefinition] = {
    "tech_growth": GroupDefinition(
        name="tech_growth",
        tickers=("QQQ", "XLK", "AIQ", "BOTZ", "CIBR", "HACK", "IGV", "SOXX", "PSI", "FTXL", "XSD", "SMH", "DRAM"),
        limit_pct=0.35,
    ...
    "semiconductors": GroupDefinition(
        name="semiconductors",
        tickers=("SOXX", "PSI", "FTXL", "XSD", "SMH", "DRAM"),
        limit_pct=0.25,
        loss_review_threshold=-0.04,
        asset_type="thematic",
    ),
    ...
    "consumer_discretionary": GroupDefinition(
    ...
    "communication_services": GroupDefinition(
