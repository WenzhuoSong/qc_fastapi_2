...
class DecisionLedgerTests(unittest.TestCase):
    ...
    def test_holding_without_proposed_trade_gets_hold_row_and_explanation_reference(self):
        ...
        self.assertEqual(row["explanation"]["why_hold"], explanation["why_hold"])
        self.assertIn("strategy_intent", row["explanation"])
        self.assertIn("llm_effect", row["explanation"])
        self.assertIn("construction_effect", row["explanation"])
        self.assertIn("risk_governance_effect", row["explanation"])
        self.assertIn("final_explanation", row["explanation"])
        self.assertIn("execution_chain", row["explanation"])
